...
For an overview of the directory structure and what each folder contains, please see the [README.md](./README.md#project-structure).

## ⚡ Quick Start & Development

👉 **For Installation, Configuration, Seeding Data, and Development Commands, please refer to the main [README.md](./README.md).**
